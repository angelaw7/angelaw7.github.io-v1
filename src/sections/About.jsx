				...
				<div style={{ display: "flex" }}>
					<div>
						<p>
							...
							<br /><br />
							When I’m not in front of a computer screen, I usually like to go swimming, rock climbing, or out for a walk. I also wish to travel more in the future to experience different cultures and lifestyles, admire scenery, and to try new foods!						</p>
					</div>
					<div>
						<iframe
