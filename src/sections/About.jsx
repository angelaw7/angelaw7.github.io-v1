	...
	return (
		<div id="about">
			<PageContainer>
				<h1>About</h1>
				<IonRow>
					<IonCol size-sm={12 }size-md={12} size-lg={8} style={{ paddingRight: "40px" }} >
						<p>
							Hello and welcome to my internet bubble! My name is Angela Wang and I’m a Software & Biomedical Enginnering student at McMaster University, in Hamilton, Ontario. I’m passionate about healthcare and technology, and I hope to one day work on developing innovate biomedical devices and software.
							<br /><br />
					...
					<IonCol size-lg={4} >
						<iframe
							...
							style={{ width: "385px", height: "201px", border: 0, transform: "scale(1)", overflow: "hidden", margin: 'auto'}}
